...
export const en: TranslationMap = {
  ...
  // Player Groups
  'nav.players': 'Players',
  'nav.playerGroups': 'Groups',
  'playerGroups.title': 'Player Groups',
  'playerGroups.active': 'Active',
  'playerGroups.players': '{count} players',
  'playerGroups.tournaments': '{count} tournaments',
  'playerGroups.switch': 'Switch',
  'playerGroups.switchBlocked': 'Finish or cancel the current tournament first',
  'playerGroups.create': 'New Group',
  'playerGroups.maxReached': 'Maximum 3 groups',
  'playerGroups.import': 'Import',
  'playerGroups.export': 'Export',
  'playerGroups.delete': 'Delete',
  'playerGroups.deleteConfirm': 'Delete "{name}"? This permanently removes all players and tournament history in this group.',
  'playerGroups.rename': 'Rename',
  'playerGroups.importError': 'Invalid file format',
  'playerGroups.importMaxError': 'Cannot import — maximum 3 groups reached',
  'playerGroups.defaultName': 'My Players',
  'playerGroups.lastUpdated': 'Last updated: {date}',
  'playerGroups.empty': 'No groups yet',

  // Players
  'players.title': 'Players',
  'players.search': 'Search players...',
  'players.showArchived': 'Show archived',
  'players.addPlayer': 'Add Player',
  'players.addPlayerPlaceholder': 'Player name',
  'players.noPlayers': 'No players registered yet. Start a tournament to add players!',
  'players.name': 'Name',
  'players.tournaments': 'Tournaments',
  'players.matches': 'Matches',
  'players.winRate': 'Win Rate',
  'players.lastActive': 'Last Active',
  'players.never': 'Never',
  'players.archived': 'Archived',
  'players.archive': 'Archive',
  'players.unarchive': 'Unarchive',
  'players.deleteConfirm': 'Permanently delete "{name}"? All history will be lost.',
  ...
  'players.bestFinish': 'Best finish',
  'players.worstFinish': 'Worst finish',
  'players.currentStreak': 'Current streak',
  'players.bestStreak': 'Best streak',
  'players.recentForm': 'Recent form',
  'players.partners': 'Partners',
  'players.opponents': 'Opponents',
  'players.matchesTogether': 'Matches',
  'players.matchesAgainst': 'Matches',
  'players.tournamentHistory': 'Tournament History',
  'players.rank': '{rank}/{total}',
  'players.excluded': 'Fun game',
  'players.noHistory': 'No tournaments yet',

  // Setup: Autocomplete
  'setup.newPlayer': 'New player — will be registered as "{name}"',
  'setup.showArchived': 'Show archived',
  'setup.playerExists': 'Select "{name}" from the list to link to existing player',
  'setup.noMatchingPlayers': 'No matching players',
